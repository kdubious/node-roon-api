...
var Moo = /** @class */ (function () {
    ...
    Moo.prototype._subscribe_helper = function (svcname, reqname, argsOrCB, cb) {
        var _this = this;
        ...
        this.send_request(svcname + "/subscribe_" + reqname, subscription_args, function (msg, body) {
            if (cb)
                cb(msg && msg.name == "Success" ? false : (msg ? msg.name : "NetworkError"), body);
        });
        return {
            unsubscribe: function (ucb) {
                _this.send_request(svcname + "/unsubscribe_" + reqname, { subscription_key: subkey }, ucb);
            }
        };
    };
    ;
    ...
    Moo.prototype.handle_response = function (msg, body) {
        var req = this.requests[msg.request_id];
        if (!req) {
